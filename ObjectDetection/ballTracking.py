...
while True:
    ...
    red1_block_mask = cv2.inRange(hsv_img, red1min, red1max)
    red2_block_mask = cv2.inRange(hsv_img, red2min, red2min)
    ...
    contours, _ = cv2.findContours(red_block_mask.copy(), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
