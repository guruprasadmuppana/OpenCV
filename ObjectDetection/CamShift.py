...
red1_block_mask = cv2.inRange(hsv_roi,red1min,red1max)
red2_block_mask = cv2.inRange(hsv_roi,red2min,red2min)
red_block_mask = cv2.bitwise_or(red1_block_mask,red2_block_mask)


# Obtain the color histogram of the ROI
roi_hist = cv2.calcHist([hsv_roi], [0], red_block_mask, [180], [0, 180])
